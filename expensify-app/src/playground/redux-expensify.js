...
const getVisibleExpenses = (expenses, { text, sortBy, startDate, endDate }) => { // destructure filters object
...
const expenseOne = store.dispatch(addExpense({description: 'January Rent', amount: 1000, createdAt: -1000}))
